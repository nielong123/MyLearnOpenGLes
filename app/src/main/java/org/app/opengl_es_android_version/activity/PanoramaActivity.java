...
import org.app.opengl_es_android_version.renderer.PanoramaRenderer;
...
public class PanoramaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (supportEs2) {
            ...
            panoramaRenderer = new PanoramaRenderer(this);
            glSurfaceView.setRenderer(panoramaRenderer);
            rendererSet = true;
        } else {
