...
import org.app.opengl_es_android_version.renderer.PictureRenderer;

public class PictureTextureActivity extends AppCompatActivity {

    private GLSurfaceView glSurfaceView;

    private boolean rendererSet = false;

    private PictureRenderer ballRenderer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (supportEs2) {
            ...
            ballRenderer = new PictureRenderer(this);
