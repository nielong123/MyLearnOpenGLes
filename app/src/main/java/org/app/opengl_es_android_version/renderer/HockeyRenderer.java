...
public class HockeyRenderer implements GLSurfaceView.Renderer {
    ...
    public HockeyRenderer(Context context) {
        ...
        vertexShaderSource = TextResourceReader.readTextFileFromResource(context, R.raw.simple_vertex_shader1_5);
        fragmentShaderSource = TextResourceReader.readTextFileFromResource(context, R.raw.simple_fragment_shader1_5);
